...
--
-- Host: localhost    Database: fin_tracker
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `budgetlimit`;
...
--
-- Dumping data for table `budgetlimit`
--

LOCK TABLES `budgetlimit` WRITE;
/*!40000 ALTER TABLE `budgetlimit` DISABLE KEYS */;
/*!40000 ALTER TABLE `budgetlimit` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-12-14 21:59:21
